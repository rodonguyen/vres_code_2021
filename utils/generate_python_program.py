...
destination_dir = "programs/neural_network/mnist/code3layers/"
...
# row_nums_test = [26, 97, 150, 373, 642, 1234, 4880, 4101]
col_nums = (0,)
...
generate_nn_code(mnist_program_3layers, row_nums)
# print(row_nums)