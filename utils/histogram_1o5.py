...
def plot(line, type):
    ...
    # csv = open('count_result/histogram-push-and-pop.csv', 'a')
    # csv.write(dataset_name + '\n')
    ...
    # # Plot shadow Confidence Interval layer
    ...
    # # Plot the histogram again to overlay the CI layer 
